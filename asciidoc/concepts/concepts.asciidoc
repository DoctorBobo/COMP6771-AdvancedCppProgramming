...
|specify the functions necessary for a class to conform to its type                  |specify whether a model is of some type                                  |specify the syntactic properties for a type used in some algorithm
