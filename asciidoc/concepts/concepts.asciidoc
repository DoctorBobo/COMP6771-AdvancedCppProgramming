...
|are like a grfgsgb                                                                  |are like a bouncer
|=========================
...
syntactic property (e.g. "class overloads `operator+`), but rather to enforce that a type meets some
otherwise theoretical concept. Concepts make the intangible tangible!
