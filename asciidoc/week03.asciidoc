...
* link:http://en.cppreference.com/w/cpp/language/static_cast[cppreference.com -- `static_cast`
  conversion]
* link:http://en.cppreference.com/w/cpp/language/dynamic_cast[cppreference.com -- `dynamic_cast`
  conversion]
* link:http://en.cppreference.com/w/cpp/language/reinterpret_cast[cppreference.com --
  `reinterpret_cast` conversion]
* http://en.cppreference.com/w/cpp/language/const_cast[cppreference.com -- `const_cast` conversion]
...
* link:http://en.cppreference.com/w/cpp/container/vector[cppreference.com -- `std::vector`]
* link:http://en.cppreference.com/w/cpp/container/vector_bool[cppreference.com -- `std::vector<bool>`]
...
* Stroustrup, B. _Programming: principles and practice using {cpp}_. Second edition. p.747 -- 748. 2014.
  Pearson Education, Inc. Upper Saddle River, NJ.
* link:http://en.cppreference.com/w/cpp/container/array[cppreference.com -- `std::array`]
...
* link:http://en.cppreference.com/w/cpp/string/basic_string[en.cppreference.com --
  `std::basic_string`]
=====
...
int accumulate_from_keyboard(std::vector<int>);
int sum(int, int);

int accumulate_from_keyboard(std::vector<int> v)
{
...
int accumulate_int(const std::vector<int>& v)
{
   return std::accumulate(v.cbegin(), v.cend());<F5>
}
------------
...
void fill_from_keyboard(vector<int>& v)
{
   for (auto i = 0; std::cin >> i; )
      v.push_back(i);
}
...
[TIP]
=====
* link:http://en.cppreference.com/w/cpp/container/list[en.cppreference.com -- `std::list`]
=====
== `forward_list`
...
[TIP]
=====
* link:http://en.cppreference.com/w/cpp/container/forward_list[en.cppreference.com --
  `std::forward_list`]
=====
...
* Stroustrup, B. _A tour of {cpp}_. p.102 -- 103. 2014. Pearson Education, Inc. Upper Saddle River,
  NJ.
* link:http://en.cppreference.com/w/cpp/container/unordered_map[en.cppreference.com --
  `std::unordered_map`]
* link:http://en.cppreference.com/w/cpp/container/unordered_multimap[en.cppreference.com --
  `std::unordered_multimap`]
* link:http://en.cppreference.com/w/cpp/container/unordered_set[en.cppreference.com --
  `std::unordered_set`]
* link:http://en.cppreference.com/w/cpp/container/unordered_multiset[en.cppreference.com --
...
* Stroustrup, B. _Programming: principles and practice using {cpp}_. Second edition. p.757 -- 801.
  Pearson Education, Inc. Upper Saddle River, NJ.
* link:http://en.cppreference.com/w/cpp/container/map[en.cppreference.com -- `std::map`]
* link:http://en.cppreference.com/w/cpp/container/multimap[en.cppreference.com -- `std::multimap`]
* link:http://en.cppreference.com/w/cpp/container/set[en.cppreference.com -- `std::set`]
* link:http://en.cppreference.com/w/cpp/container/multiset[en.cppreference.com -- `std::multiset`]
=====
...
* Stroustrup, B. _Programming: principles and practice using {cpp}_. Second edition. p.119. 2014.
  Pearson Education, Inc. Upper Saddle River, NJ.
* link:https://github.com/isocpp/CppCoreGuidelines/blob/master/CppCoreGuidelines.md#Res-for-range[ES.71:
  Prefer a range-`for`-statement to a `for`-statement when there is a choice]
* link:http://en.cppreference.com/w/cpp/language/range-for[en.cppreference.com -- Range-based `for`
  loop]
...
[TIP]
=====
* link:http://en.cppreference.com/w/cpp/concept/OutputIterator[en.cppreference.com -- {cpp}
  concepts OutputIterator]
=====
...
int main()
{
   ...
   std::copy(names.cbegin(), names.cend(), std::ostream_iterator<decltype(names)::value_type>{std::cout, "\n"});
}
------------
...
[TIP]
=====
1. link:http://en.cppreference.com/w/cpp/concept/InputIterator[en.cppreference.com -- {cpp}
...
1. ISO/IEC. Working Draft, Standard for Programming Language {cpp}, p.852. 2014. ISO/IEC, Geneva
   Switzerland.
2. link:http://en.cppreference.com/w/cpp/concept/ForwardIterator[en.cppreference.com -- {cpp}
...
1. ISO/IEC. Working Draft, Standard for Programming Language {cpp}, p.852. 2014. ISO/IEC, Geneva
   Switzerland.
2. link:http://en.cppreference.com/w/cpp/concept/BidirectionalIterator[en.cppreference.com -- {cpp}
...
1. ISO/IEC. Working Draft, Standard for Programming Language {cpp}, p.852. 2014. ISO/IEC, Geneva
   Switzerland.
2. link:http://en.cppreference.com/w/cpp/concept/RandomAccessIterator[en.cppreference.com -- {cpp}
...
.Item not relevant for modern {cpp}
[CAUTION]
=========
...
int main()
{
   auto ages = std::vector<int>{std::istream_iterator<int>{std::cin}, std::istream_iterator<int>{}};
   std::sort(ages.begin(), ages.end());
   std::copy(ages.crbegin(), ages.rend(), std::ostream_iterator<decltype(ages)::value_type>{std::cout, " "});
   std::cout << '\n';
}
------------
...
* link:http://en.cppreference.com/w/cpp/algorithm[en.cppreference.com -- Algorithms library]
